...
RSpec.describe CoinbaseCommerceClient::APIResources::Base::APIObject do
  describe "#respond_to" do
    it "should implement respond_to method" do
      obj = CoinbaseCommerceClient::APIResources::Base::APIObject.create_from(id: 1, foo: "bar")
  ...
  describe "#serialize params" do
    it "should serialize params on an empty object" do
      obj = CoinbaseCommerceClient::APIResources::Base::APIObject.create_from({})
      expect({}).to eq obj.serialize_params
    end

    it "should serialize params on a new object with a sub object" do
      obj = CoinbaseCommerceClient::APIResources::Base::APIObject.new
      obj.metadata = {foo: "bar"}
      expect({metadata: {foo: "bar"}}).to eq obj.serialize_params
    end

    it "should serialize params on a basic object" do
      obj = CoinbaseCommerceClient::APIResources::Base::APIObject.create_from(foo: nil)
    ...
    it "should serialize params on a complex object" do
      obj = CoinbaseCommerceClient::APIResources::Base::APIObject.create_from(
        foo: CoinbaseCommerceClient::APIResources::Base::APIObject.create_from(bar: nil, baz: nil))
      obj.foo.bar = "newbar"
    ...
    it "should serialize params on an array that shortens" do
      obj = CoinbaseCommerceClient::APIResources::Base::APIObject.create_from(foo: ["0-index", "1-index", "2-index"])
      obj.foo = ["new-value"]
      expect({foo: ["new-value"]}).to eq obj.serialize_params
    end
    ...
    it "should serialize params on an array of hashes" do
      obj = CoinbaseCommerceClient::APIResources::Base::APIObject.create_from(foo: nil)
      obj.foo = [
        CoinbaseCommerceClient::APIResources::Base::APIObject.create_from(bar: nil),
      ]
      obj.foo[0].bar = "baz"
    ...
    it "should serialize params with a APIObject" do
      obj = CoinbaseCommerceClient::APIResources::Base::APIObject.create_from({})
      obj.metadata = CoinbaseCommerceClient::APIResources::Base::APIObject.create_from(foo: "bar")
    ...
    it "should serialize params with APIObject that's been replaced" do
      obj = CoinbaseCommerceClient::APIResources::Base::APIObject.create_from(
        source: CoinbaseCommerceClient::APIResources::Base::APIObject.create_from(bar: "foo"))

      obj.source = CoinbaseCommerceClient::APIResources::Base::APIObject.create_from(baz: "foo")
    ...
    it "should serialize params with an array of APIObjects" do
      ...
      obj = CoinbaseCommerceClient::APIResources::Base::APIObject.create_from({})
      obj.metadata = [
        CoinbaseCommerceClient::APIResources::Base::APIObject.create_from(foo: "bar"),
      ]
    ...
    it "should serialize params with embed API resources" do
      charge = CoinbaseCommerceClient::APIResources::Charge.create_from(id: "charge_id")
      obj = CoinbaseCommerceClient::APIResources::Base::APIObject.create_from({})
      obj.charge = charge
      expect(obj.charge).is_a? CoinbaseCommerceClient::APIResources::Charge
    end

    it "should serialize params and not include API resources that have not been set" do
      obj = CoinbaseCommerceClient::APIResources::Base::APIObject.create_from(id: "cus_123")
      obj2 = CoinbaseCommerceClient::APIResources::Base::APIObject.create_from(obj: obj)
    ...
    it "should serialize params takes a push option" do
      obj = CoinbaseCommerceClient::APIResources::Base::APIObject.create_from(
        id: "id", metadata: CoinbaseCommerceClient::APIResources::Base::APIObject.create_from(foo: "bar"))
  ...
  describe "update attributes" do
    it "should update attributes with a hash" do
      ...
      expect(obj.metadata.class).to eq CoinbaseCommerceClient::APIResources::Base::APIObject
    end
    ...
    it "should assign question mark accessors for booleans" do
      obj = CoinbaseCommerceClient::APIResources::Base::APIObject.create_from(id: 1, bool: true, not_bool: "bar")
      expect(obj.respond_to?(:bool?)).to be true
    ...
    it "should update attributes with a hash" do
      obj = CoinbaseCommerceClient::APIResources::Base::APIObject.create_from({})
      obj.update_attributes(metadata: {foo: "bar"})
      expect(CoinbaseCommerceClient::APIResources::Base::APIObject).to eq obj.metadata.class
    end
