...
RSpec.describe CoinbaseCommerceClient do
  ...
  it "should get charges" do
    ...
    expect(charge_list.pagination).is_a? CoinbaseCommerceClient::APIResources::Base::APIObject
  ...
  it "should get checkouts" do
    ...
    expect(checkout_list.pagination).is_a? CoinbaseCommerceClient::APIResources::Base::APIObject
  ...
  it "should should get events" do
    ...
    expect(event_list.pagination).is_a? CoinbaseCommerceClient::APIResources::Base::APIObject
  ...
  it "should get charge" do
    ...
    expect(charge).is_a? CoinbaseCommerceClient::APIResources::Base::APIObject
  ...
  it "should get checkout" do
    ...
    expect(checkout).is_a? CoinbaseCommerceClient::APIResources::Base::APIObject
  ...
  it "should get event" do
    ...
    expect(event).is_a? CoinbaseCommerceClient::APIResources::Base::APIObject
