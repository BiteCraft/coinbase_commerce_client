...
RSpec.describe CoinbaseCommerceClient do
  ...
  it "should get appropriate error when invalid response object" do
    ...
    expect {@client.checkout.list}.to raise_error CoinbaseCommerceClient::Errors::APIError
  end
  ...
  it "should handle invalid request general" do
    ...
    expect {@client.checkout.list}.to raise_error CoinbaseCommerceClient::Errors::InvalidRequestError
  end
  ...
  it "should handle param required" do
    ...
    expect {@client.checkout.list}.to raise_error CoinbaseCommerceClient::Errors::ParamRequiredError
  end
  ...
  it "should handle validation error" do
    ...
    expect {@client.checkout.list}.to raise_error CoinbaseCommerceClient::Errors::ValidationError
  end
  ...
  it "should handle authentication error" do
    ...
    expect {@client.checkout.list}.to raise_error CoinbaseCommerceClient::Errors::AuthenticationError
  end
  ...
  it "should handle resource not found error" do
    ...
    expect {@client.checkout.list}.to raise_error CoinbaseCommerceClient::Errors::ResourceNotFoundError
  end
  ...
  it "should handle rate limit exceeded error" do
    ...
    expect {@client.checkout.list}.to raise_error CoinbaseCommerceClient::Errors::RateLimitExceededError
  end
  ...
  it "should handle internal server error" do
    ...
    expect {@client.checkout.list}.to raise_error CoinbaseCommerceClient::Errors::InternalServerError
  end
  ...
  it "should handle service unavailable error" do
    ...
    expect {@client.checkout.list}.to raise_error CoinbaseCommerceClient::Errors::ServiceUnavailableError
  end
end